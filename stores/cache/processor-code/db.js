...
module.exports = new class {
    ...
    ready = async () => {
        ...
        await this.#run('CREATE TABLE IF NOT EXISTS processors_code (' +
            'processor_code_id TEXT NOT NULL, ' +
            'data TEXT NOT NULL);');

        await this.#run('CREATE UNIQUE INDEX IF NOT EXISTS id_index on processors_code (id);');
        this.#ready.resolve();
    }
}
