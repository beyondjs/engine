...
module.exports = class extends DynamicProcessor {
	get dp() {
		return 'package.deployment.distribution';
	}

	#package;

	get id() {
		return `${this.#package.id}//${this.#key}`;
	}
	...
	constructor(pkg, config, local, key) {
		super();
		this.#errors = [];
		...
		this.#bundles = (() => {
			...
			const def = platforms.node.includes(this.#platform)
				? 'cjs'
				: platforms.webAndMobile.includes(this.#platform)
				? 'sjs'
				: 'esm';
