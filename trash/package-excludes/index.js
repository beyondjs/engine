...
module.exports = class extends DynamicProcessor {
	...
	// Check if a module is excluded in the package
	excludedByConfiguration = module =>
		this.#value.reduce((prev, exclude) => {
			if (!this.processed)
				throw new Error('Object not processed. Check that await .ready was previously executed.');
	 ...
	 */
	check(module) {
		if (module.engines && !module.engines.includes(this.#package.engine)) return true;
