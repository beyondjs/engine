...
/**
 * Map with all the dependencies of the application
 * Where the key of the map is the dependency id, and the value is its url
 *
 * The dependency id is not related to the PLM id, but it is:
 * . the resource when it refers to a bundle of a module of the application
 * . the resource including the version number when it is an external package
 */
module.exports = class extends DynamicProcessor {
    ...
    get importMap() {
        ...
        (() => {
            const baseDir = this.#distribution.baseDir ? this.#distribution.baseDir : '/';
            const required = [
                '@beyond-js/kernel/transversals',
