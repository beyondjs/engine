...
module.exports = async function (specs) {
    ...
    (distribution.maps, packager, 'ts', p.join(path, bundle.subpath), builder, language);
    ...
    const cleanup = packager => {
        ...
        const {packager: {compiler}} = packager.processors.get('ts');
        compiler.dispose();
    }
