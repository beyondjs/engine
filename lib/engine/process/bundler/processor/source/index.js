...
module.exports = class {
    ...
    get url() {
        ...
        let url = relative(this.#processor.bundle.path, this.#source.file);
    ...
    constructor(processor, distribution, is, source) {
        ...
        if (!distribution.npm && !distribution.platform) throw new Error('Invalid parameters');
        if (processor?.is !== 'processor') throw new Error('Invalid parameters');
