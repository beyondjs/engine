module.exports = class extends require('../base') {
    ...
    _prepared(require) {
        ...
        if (!this.children.has('dependencies')) {
            const {distribution, dependencies, application} = this.packager;
             ...
             */
            distribution.local && children.set('dependencies.packages', {child: application.dependencies.packages});
