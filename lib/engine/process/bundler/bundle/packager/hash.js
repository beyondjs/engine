...
module.exports = class extends DynamicProcessor {
    ...
    constructor(packager) {
        ...
        const children = new Map([
            ...
            ['deprecated-imports', {child: packager.bundle.imports.hash}],
            ['dependencies.packages', {child: packager.application.dependencies.packages}]
        ]);
        ...
        children.set('dependencies.packages', {child: application.dependencies.packages});
