...
module.exports = class extends AnalyzerSource {
    ...
    #declarationMap;
    get declarationMap() {
        if (this.#declarationMap !== void 0) return this.#declarationMap;

        let map = this.#compiled.declarationMap;
        this.#declarationMap = map = typeof map === 'string' ? JSON.parse(map) : map;
        return map;
    }
