...
exports.create = compiler => {
    ...
    const dependenciesRoot = (() => {
        const path = join(specs.application.path, '/node_modules/');
    ...
    const getBeyondSource = (resource) => {
        ...
        resource.endsWith('@beyond-js/kernel/core.d.ts') && console.log('get source:', module, resource, dependenciesRoot);
    ...
    host.resolveModuleNames = function (modules, container) {
        ...
        modules.forEach(module => {
            ...
            if (declarations.has(module)) {
                ...
                module.endsWith('@beyond-js/kernel/core') && (activate = true) && console.log('module resolved', resolved, module);
            ...
            module.endsWith('@beyond-js/kernel/core') && console.log('module resolved not as a declaration', resolved, module);
