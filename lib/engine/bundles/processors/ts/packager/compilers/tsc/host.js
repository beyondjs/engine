...
exports.create = (compiler) => {
    ...
    const getBeyondSource = (resource) => {
         ...
         */
        let module = resource.startsWith('/node_modules/') && resource.endsWith('.d.ts') &&
            resource.substr(14, resource.length - 19); // Remove '/node_modules/' and the .d.ts extension
    ...
    host.resolveModuleNames = function (modules, container) {
        ...
        modules.forEach(module => {
            ...
            if (declarations.has(module)) {
                return push(module, `/node_modules/${module}.d.ts`);
            }
