...
exports.create = compiler => {
    ...
    const dependenciesRoot = join(specs.application.path, '/node_modules/');
    ...
    const getBeyondSource = (resource) => {
        ...
        resource.includes('@beyond-js/kernel/core') && console.log(module, resource, dependenciesRoot);
    ...
    host.resolveModuleNames = function (modules, container) {
        ...
        modules.forEach(module => {
            ...
            resolved.includes('@beyond-js/kernel/core') && console.log('resolved', resolved, module);
