...
module.exports = class {
    ...
    /**
     * Data collected from the visitor
     * Actually the name of the default export property as default cannot be used inside a namespace
     * @type {{default: string}}
     */
    #data = {};
    get data() {
    ...
    process(ims, dependencies) {
        ...
        try {
            ...
            const transformed = transform(input.code, {
                cwd,
                sourceType: 'module',
