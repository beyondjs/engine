...
module.exports = class extends DynamicProcessor {
	...
	_preapred(require) {
		require(this.#project.template.global);
	}
	...
	_process() {
		...
		this.#project.template.global.valid && (config['global.css'] = true);
		...
		({ code } = mformat({ code, format: mode }));
		this.#code = code;

		this.#declaration = require('./declaration');
	}
};
