const BEE = require('../../../../packages/bee');
...
(() => {
    ...
    const {project, distribution, ports} = specs;
    ...
    bimport('/start').then(() => {
        ...
        // It is required by @beyond-js/inspect/local to know where the server is ready to accept requests
