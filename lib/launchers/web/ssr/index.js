...
module.exports = class {
    ...
    async data(distribution) {
        if (this.#promises.data) return await this.#promises.data;
        this.#promises.data = new PendingPromise();
    ...
    async ready(distribution) {
        ...
        if (this.#promises.ready) return await this.#promises.ready;
        ...
        await ipc.exec('main', 'launchers/start', id);
        await ipc.exec('main', 'launchers/ready', id);
        this.#promises.ready.resolve();
    }
}
