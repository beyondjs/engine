...
module.exports = class BeyondServer extends require("../file-manager") {
    ...
    #defaultTPL = {applications: 'packages.json', bundles: {}};
    ...
    constructor(path) {
        ...
        if (exists) this.load();
            ...
            this.#packages = new (require("./packages"))(this.file.dirname, this.file.json.applications);
        }
    }
    ...
    save = () => {
        ...
        const specs = {applications: this.#packages.value};
