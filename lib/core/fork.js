...
new class extends EventEmitter {
    ...
    constructor(path) {
        ...
        this.#repository = new (require('./repository'))(this.#packages, {port: registry});
        this.#applications = new (require('./applications'))(config.get('applications', {inspect}));
